...
const fetchItems = async (from = 0, to = MAX_ITEMS_PER_REQUEST) => {
    try {
        ...
        const fetchProms = await get(`https://mercadao.pt/api/catalogues/6107d28d72939a003ff6bf51/products/search?query=%5B%5D&sort=%7B%22activePromotion%22:%22desc%22%7D&from=${from}&size=${to}&esPreference=0.9387125693742042`, {
            headers: {
