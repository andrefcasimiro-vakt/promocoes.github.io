...
const extract = async () => {
    ...
    if (!fs.existsSync(htmlFilePath)) {
        ...
        const allHtml = await get(`https://www.continente.pt/on/demandware.store/Sites-continente-Site/default/Search-UpdateGrid?cgid=col-produtos&pmin=0%2e01&prefn1=isPromo&prefv1=true&start=0&sz=${totalProducts}`, {
            headers: {
                'User-Agent': 'Request-Promise',
            },
        });
